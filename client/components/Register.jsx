  ...
  render() {
    ...
    return (
      <form className="Register form box" onSubmit={this.handleSubmit}>
        ...
        <label className="column is-6 is-offset-one-quarter label is-large has-text-centered">Email
          <input required className="input is-large has-text-centered is-fullwidth" placeholder="E-mail" type="text" name="email" autoComplete="email" onChange={this.handleChange} value={this.state.email} />
        </label>
